...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    spread_exchange = exchange_rate * (spread / 100)
    changed_money = int(exchange_money(budget, exchange_rate + spread_exchange))


    max_notes = changed_money // denomination
    return max_notes * denomination