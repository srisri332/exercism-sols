...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    match percentage:
        case p if p >= 80:
            return 'green'
        case p if p < 80 and p >= 60:
            return 'orange'
        case p if p < 60 and p >= 30:
            return 'red'
        case p if p < 30:
            return 'black'
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    ninety_percent = 0.9 * threshold
    ten_percent = 0.1 * threshold
    temp_mult_neutrons = temperature * neutrons_produced_per_second

    match temp_mult_neutrons:
        case tmn if tmn < ninety_percent:
            return "LOW"
        case tmn if tmn > threshold - ten_percent and tmn < threshold + ten_percent:
            return "NORMAL"
        case _:
            return "DANGER"
